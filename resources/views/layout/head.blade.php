<head>
    ...
    <title>{{$setting['general.app_name'] ?? ''}} | {{$setting['seo.site_title'] ?? ''}}</title>
    ...
    <link href="/assets/css/style.css" rel="stylesheet">
     ...
     <!-- CSS Skin File -->
     <link id="dynamic-theme" href="/assets/css/skins/{{ $setting['general.theme_color'] ?? 'default' }}.css" rel="stylesheet">
