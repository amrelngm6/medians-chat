                ...
                <footer id="chat-footer" class="chat-footer">
                    <div id="input-nav-wrapper" class="input-nav-wrapper">
                        ...
                        <div class="input-area-visual">
                            ...
                            <?php if(!empty($setting['site.allow_speech_text'])): ?>
                    ...
                    <?php if(!empty($setting['site.show_footer_menu'])): ?>
                    <div class="scroll-flow-progress-slot" aria-label="Chat flow progress"></div>
                    <?php endif; ?>
                    <!-- Footer Bottom Text Starts -->
                    <p id="chat-footer-text"><i class="fa-regular fa-comment-dots"></i> <?php echo e($setting['site.footer_text'] ?? ''); ?></p>
                    <!-- Footer Bottom Text Ends -->
                </footer><?php /**PATH C:\xampp\htdocs\medians_chat\resources\views/sections/components/chat-footer.blade.php ENDPATH**/ ?>