    ...
    <div id="theme-switcher" class="theme-panel opacity-0">
        ...
        <div class="theme-options">
            ...
            <div class="theme-grid">
                ...
                <button class="skin-btn theme-green" data-file="theme-green.css"></button>
                <button class="skin-btn theme-gold" data-file="theme-gold.css"></button>
                <button class="skin-btn theme-blue" data-file="theme-blue.css"></button>
