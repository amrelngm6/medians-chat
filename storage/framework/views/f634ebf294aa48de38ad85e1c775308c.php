    ...
    <div class="skin">
        ...
        <?php if(!empty($setting['site.show_dark_mode'])): ?>
        ...
        <?php if(!empty($setting['site.show_languages'])): ?>
    ...
    <?php if(!empty($setting['site.show_color_switcher'])): ?>
    <!-- Color Switcher Starts / Only Demo -->
        <?php echo $__env->make('sections.components.color-switcher', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <!-- Color Switcher Ends / Only Demo -->
    <!-- Color Switcher JS File / Only Demo -->
    <script src="/assets/js/colorswitcher.js"></script>
    <?php endif; ?>
<?php /**PATH C:\xampp\htdocs\medians_chat\resources\views/layout/footer.blade.php ENDPATH**/ ?>